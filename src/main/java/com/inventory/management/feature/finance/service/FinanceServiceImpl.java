package com.inventory.management.feature.finance.service;
...
public class FinanceServiceImpl implements FinanceService {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(FinanceServiceImpl.class);
    ...
    public Map<String, Object> dashboard() {
        ...
        log.info(
                "Sales calculation completed | Total Sales : {}",
                totalSales);
        ...
        BigDecimal netBusiness =
                totalSales.subtract(payable);

        log.info(
                "Net business calculated : {}",
                netBusiness);
        ...
        log.info(
                "Finance dashboard loaded successfully");
