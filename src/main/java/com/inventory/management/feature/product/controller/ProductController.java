package com.inventory.management.feature.product.controller;
...
import com.inventory.management.feature.master.repository.SubCategoryRepository;
...
import com.inventory.management.feature.product.service.ProductService;
    ...
    public ResponseEntity<ApiResponse<Product>> create(
        ...
        String barcode =
                body.get("barcode") != null
                        ? body.get("barcode").toString().trim()
                        : "";
        ...
        if (
            ...
            throw new RuntimeException(
                    "Either Category or Sub Category is required");
        }
